package parseData
{
	...
	public class DataUtil extends EventDispatcher
	{
		...
		public function getDataAndDrawLine(lineArr:ArrayCollection,getDataFun : Function,addNode:Object,event : String,mess : String):void{
			eventName = event;
			message = mess;
		...
		private function getHeightWayPointByLineId(pointArr : ArrayCollection):void{
			...
			addNodeFun.addEventListener("addLineSuccessed",addLineSuccessedFun);
			addNodeFun.addBoundary(pointArr);
		}
		private function addLineSuccessedFun(e:Event):void{
			addNodeFun.removeEventListener("addLineSuccessed",addLineSuccessedFun);
			if( LineArrLength == 0 ){
