...
//		}
		...
		public static function getProvincialLineInMaxMinCoordinate(startCol:Number,startRow:Number,zoom:Number,rebackFun:Function):void{
			getAreaInfo("getProvincialLineInMaxMinCoordinate",[startCol,startRow,zoom],rebackFun);
		}
		...
		public static function getAreaRangeCityPolygonPoints(startCol:Number,startRow:Number,zoom:Number,rebackFun:Function):void{
			if( !checkUrl())	return;
			getAreaInfo("getAreaRangeCityPolygonPoints",[startCol,startRow,zoom],rebackFun);
		}
		/**
		 * 获取区域内县的边界 
		 */
		public static function getAreaRangeCountyPolygonPoints(startCol:Number,startRow:Number,zoom:Number,rebackFun:Function):void{
			if( !checkUrl())	return;
			getAreaInfo("getAreaRangeCountyPolygonPoints",[startCol,startRow,zoom],rebackFun);
		}
		 ...
		 */
		public static function getAreaLines(startCol:Number,startRow:Number,zoom:Number,rebackFun:Function):void{
			getAreaInfo("getRailwayLineInMaxMinCoordinate",[startCol,startRow,zoom],rebackFun);
		}
		 ...
		 *	获取高速公路的线段 
		 */
		public static function getHighwayLineInMaxMinCoordinate(startCol:Number,startRow:Number,zoom:Number,rebackFun:Function):void{
			getAreaInfo("getHighwayLineInMaxMinCoordinate",[startCol,startRow,zoom],rebackFun);
		}
		 ...
		 * 获取国道线段 
		 */
		public static function getNationalHighwayLineInMaxMinCoordinate(startCol:Number,startRow:Number,zoom:Number,rebackFun:Function):void{
			getAreaInfo("getNationalHighwayLineInMaxMinCoordinate",[startCol,startRow,zoom],rebackFun);
		}
		 ...
		 *	 省道公路线
		 */
		public static function getProvincialHighwayLineInMaxMinCoordinate(startCol:Number,startRow:Number,zoom:Number,rebackFun:Function):void{
			getAreaInfo("getProvincialHighwayLineInMaxMinCoordinate",[startCol,startRow,zoom],rebackFun);
		}
		 ...
		 * 县道公路线
		 */
		public static function getCountyHighwayLineInMaxMinCoordinate(startCol:Number,startRow:Number,zoom:Number,rebackFun:Function):void{
			getAreaInfo("getCountyHighwayLineInMaxMinCoordinate",[startCol,startRow,zoom],rebackFun);
		}
		 ...
		 *	城市快速公路线 
		 */
		public static function getExpresswayLineInMaxMinCoordinate(startCol:Number,startRow:Number,zoom:Number,rebackFun:Function):void{
			getAreaInfo("getExpresswayLineInMaxMinCoordinate",[startCol,startRow,zoom],rebackFun);
		}
